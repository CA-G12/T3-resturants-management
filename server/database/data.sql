...
CREATE TABLE IF NOT EXISTS chefs (
    ...
    FOREIGN KEY (resturant_id) REFERENCES resturants(id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS meals (
 ...
 ('Hot dog', 'https://images.pexels.com/photos/4637735/pexels-photo-4637735.jpeg?auto=compress&cs=tinysrgb&w=600', 8, 1,5 ),
 ('Pizza', 'https://images.pexels.com/photos/367915/pexels-photo-367915.jpeg?auto=compress&cs=tinysrgb&w=600', 15, 2, 5),
 ('Knafeh' , 'https://media.istockphoto.com/photos/kunafeh-picture-id809924948?b=1&k=20&m=809924948&s=612x612&w=0&h=8lCif7bHK-1KX7ad-ogvmArLR9X0YUi3wR0Dgn6FwU8=', 10, 1, 4),
 ('Beaf burger', 'https://images.pexels.com/photos/2271107/pexels-photo-2271107.jpeg?auto=compress&cs=tinysrgb&w=600', 16, 1, 3),
 ('Hot dog', 'https://images.pexels.com/photos/4637735/pexels-photo-4637735.jpeg?auto=compress&cs=tinysrgb&w=600', 8, 1,6),
